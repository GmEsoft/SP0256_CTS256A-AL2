...
void outWaveUpdate()
{
	...
	if ( cyclesAudio_ > 0 )
	{
		...
		{
			nCycles += clockspeed_;				
			uchar iLevelL = audioLastLevelL + nCycles * ( audioCurrentLevelL_ - audioLastLevelL )  / incCyclesAudio;
			uchar iLevelR = audioLastLevelR + nCycles * ( audioCurrentLevelR_ - audioLastLevelR )  / incCyclesAudio;
